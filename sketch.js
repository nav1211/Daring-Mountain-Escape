...
function preload(){
	...
	bisonImg = loadImage("bison.png");
	ravineImg = loadImage("ravine.jpg");
	cactiiImg = loadImage("cactus.png");
	fruitImg = loadImage("apple.png");
	veggieImg = loadImage("carrot.png");
	gateImg = loadImage("gates.jpg");
	backgroundImg = loadImage("background.jpg");
	titleImg = loadImage("image.png");
